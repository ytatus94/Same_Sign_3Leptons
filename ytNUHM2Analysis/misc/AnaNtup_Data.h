...
// Fri Nov 18 16:23:56 2016 by ROOT version 6.04/16
// from TTree AnaNtup/AnaNtup
// found on file: user.jpoveda.9808281._000001.output.root
//////////////////////////////////////////////////////////

#ifndef AnaNtup_Data_h
#define AnaNtup_Data_h
...
class AnaNtup_Data : public TSelector {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   AnaNtup_Data(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~AnaNtup_Data() { }
   ...
   ClassDef(AnaNtup_Data,0);
};

#endif

#ifdef AnaNtup_Data_cxx
void AnaNtup_Data::Init(TTree *tree)
{
