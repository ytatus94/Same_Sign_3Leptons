...
yt_cutflows::yt_cutflows()
{
    ...
    vecStringGRL.push_back(GRL_path + "data16_13TeV.periodAllYear_DetStatus-v83-pro20-15_DQDefects-00-02-04_PHYS_StandardGRL_All_Good_25ns.xml");
    ...
    confFiles.push_back("/cvmfs/atlas.cern.ch/repo/sw/database/GroupData/dev/SUSYTools/merged_prw_mc15c_latest.root"); // background
    confFiles.push_back("/cvmfs/atlas.cern.ch/repo/sw/database/GroupData/dev/SUSYTools/merged_prw_mc15c_signal_latest.root"); // signal
    ...
    lcalcFiles.push_back(PRW_path + "ilumicalc_histograms_None_297730-311481_OflLumi-13TeV-005.root");
...
bool yt_cutflows::pass_2016_trigger(bool HLT_2e17_lhvloose_nod0, bool HLT_e17_lhloose_nod0_mu14, bool HLT_mu22_mu8noL1, bool HLT_xe100_mht_L1XE50, bool HLT_xe110_mht_L1XE50, float Etmiss_TST_Et)
{
    bool pass = false;
    if (HLT_2e17_lhvloose_nod0 ||
        ...
        HLT_mu22_mu8noL1)
        pass = true;
    if ((HLT_xe100_mht_L1XE50 || HLT_xe110_mht_L1XE50) && Etmiss_TST_Et > 250000.) // only for MET > 250 GeV
        pass = true;
    return pass;
}
...
bool yt_cutflows::pass_trigger(bool isData, bool isMC, int run_number, int random_run_number,
                               ...
                               bool HLT_2e17_lhvloose_nod0, bool HLT_e17_lhloose_nod0_mu14, bool HLT_mu22_mu8noL1, bool HLT_xe100_mht_L1XE50, bool HLT_xe110_mht_L1XE50,
                               float Etmiss_TST_Et)
{
    bool pass = false;
    if (isData) {
        ...
        if (run_number > 290000) pass = pass_2016_trigger(HLT_2e17_lhvloose_nod0, HLT_e17_lhloose_nod0_mu14, HLT_mu22_mu8noL1, HLT_xe100_mht_L1XE50, HLT_xe110_mht_L1XE50, Etmiss_TST_Et);
    }
    if (isMC) {
        ...
        if (random_run_number > 290000) pass = pass_2016_trigger(HLT_2e17_lhvloose_nod0, HLT_e17_lhloose_nod0_mu14, HLT_mu22_mu8noL1, HLT_xe100_mht_L1XE50, HLT_xe110_mht_L1XE50, Etmiss_TST_Et);
    }
    return pass;
}
...
bool yt_cutflows::pass_ee_2016_trigger_matching(vector<Electron> vec_elec,
                                                bool HLT_2e17_lhvloose_nod0, bool HLT_xe100_mht_L1XE50, bool HLT_xe110_mht_L1XE50, double Etmiss_TST_Et)
{
    bool pass = false;
    // not needed if MET trigger is fired)
    if ((HLT_xe100_mht_L1XE50 || HLT_xe110_mht_L1XE50) && Etmiss_TST_Et > 250000.) {
        pass = true;
        return pass;
    }
    if (HLT_2e17_lhvloose_nod0) {
...
bool yt_cutflows::pass_emu_2016_trigger_matching(vector<Electron> vec_elec, vector<Muon> vec_muon,
                                                 bool HLT_e17_lhloose_nod0_mu14, bool HLT_xe100_mht_L1XE50, bool HLT_xe110_mht_L1XE50, double Etmiss_TST_Et)
{
    bool pass = false;
    // not needed if MET trigger is fired)
    if ((HLT_xe100_mht_L1XE50 || HLT_xe110_mht_L1XE50) && Etmiss_TST_Et > 250000.) {
...
bool yt_cutflows::pass_mumu_2016_trigger_matching(vector<Muon> vec_muon,
                                                  bool HLT_mu22_mu8noL1, bool HLT_xe100_mht_L1XE50, bool HLT_xe110_mht_L1XE50, double Etmiss_TST_Et)
{
    bool pass = false;
    // not needed if MET trigger is fired)
    if ((HLT_xe100_mht_L1XE50 || HLT_xe110_mht_L1XE50) && Etmiss_TST_Et > 250000.) {
                                        ...
                                        float Etmiss_TST_Et)
{
    ...
    if (isData) {
        if (run_number < 290000) { // 2015 data
            ...
            pass_ee_trigger = pass_ee_2016_trigger_matching(vec_elec, HLT_2e17_lhvloose_nod0, HLT_xe100_mht_L1XE50, HLT_xe110_mht_L1XE50, Etmiss_TST_Et);
            pass_emu_trigger = pass_emu_2016_trigger_matching(vec_elec, vec_muon, HLT_e17_lhloose_nod0_mu14, HLT_xe100_mht_L1XE50, HLT_xe110_mht_L1XE50, Etmiss_TST_Et);
            pass_mumu_trigger = pass_mumu_2016_trigger_matching(vec_muon, HLT_mu22_mu8noL1, HLT_xe100_mht_L1XE50, HLT_xe110_mht_L1XE50, Etmiss_TST_Et);
        }
    }
    else if (isMC) {
