...
void ytRelative_difference_of_efficiency(float pt_low = 10., float pt_up = 200., bool rebin = true, bool eta_less_than_two = false)
{
    ...
    TString path = "/Users/ytshen/Desktop/skim/Results/20170205/";
    ...
    TFile *mc_ttbar_elec = TFile::Open(path + "RLE_MC_ttbar_electron/hist-20170204.root");
    TFile *mc_ttbar_muon = TFile::Open(path + "RLE_MC_ttbar_muon/hist-20170204.root");
    TFile *mc_GG_ttn1_elec = TFile::Open(path + "RLE_MC_GG_ttn1_electron/hist-20170204.root");
    TFile *mc_GG_ttn1_muon = TFile::Open(path + "RLE_MC_GG_ttn1_muon/hist-20170204.root");
