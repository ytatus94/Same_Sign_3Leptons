...
void ytRelative_difference_of_efficiency(float pt_low = 10., float pt_up = 200., bool rebin = true, bool eta_less_than_two = false)
{
	...
	TFile *mc_ttbar_elec = TFile::Open(path + "RLE_MC_ttbar_electron/hist-20170112.root");
	TFile *mc_ttbar_muon = TFile::Open(path + "RLE_MC_ttbar_muon/hist-20170112.root");
	TFile *mc_GG_ttn1_elec = TFile::Open(path + "RLE_MC_GG_ttn1_electron/hist-20170112.root");
	TFile *mc_GG_ttn1_muon = TFile::Open(path + "RLE_MC_GG_ttn1_muon/hist-20170112.root");
...
*/
	...
	h_efficiency_difference_ttbar_elec->SetMaximum(0.5);
	h_efficiency_difference_ttbar_elec->SetMinimum(-0.5);
	...
	h_relative_difference_eff_ttbar_elec->SetMaximum(99.);
	...
	h_efficiency_difference_ttbar_muon->SetMaximum(0.5);
	h_efficiency_difference_ttbar_muon->SetMinimum(-0.5);
	...
	h_relative_difference_eff_ttbar_muon->SetMaximum(99.);
