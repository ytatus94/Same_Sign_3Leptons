#ifndef ytRealLeptonsEfficiency_MC_H
#define ytRealLeptonsEfficiency_MC_H
...
class ytRealLeptonsEfficiency_MC : public EL::Algorithm
{
...
public:
    ...
    TBranch        *b_El_DR_closest_truth_BJet; //!
    TBranch        *b_El_DR_closest_truth_CJet; //!
    TBranch        *b_El_DR_closest_truth_lightJet; //!
    ...
    TBranch        *b_El_tag_trigger_SF; //!
    TBranch        *b_Mu_ZTandP_mll; //!
    TBranch        *b_Mu_DR_closest_Jet; //!
    TBranch        *b_Mu_DR_closest_truth_BJet; //!
    TBranch        *b_Mu_DR_closest_truth_CJet; //!
    TBranch        *b_Mu_DR_closest_truth_lightJet; //!
    ...
    TH1F *h_baseline_dR_truth_Bjet; //!
    TH1F *h_baseline_dR_truth_Cjet; //!
    TH1F *h_baseline_dR_truth_Lightjet; //!
    ...
    TH2F *h_baseline_pt_dR_truth_Bjet; //! x: pt, y: dRjet
    ...
    TH1F *h_signal_dR_truth_Bjet; //!
    TH1F *h_signal_dR_truth_Cjet; //!
    TH1F *h_signal_dR_truth_Lightjet; //!
    ...
    TH2F *h_signal_pt_dR_truth_Bjet; //! x: pt, y: dRjet
    TH2F *h_signal_pt_dR_truth_Cjet; //! x: pt, y: dRjet
    TH2F *h_signal_pt_dR_truth_Lightjet; //! x: pt, y: dRjet
    ...
    TH1F *h_eff_dR_truth_Bjet; //!
    TH1F *h_eff_dR_truth_Cjet; //!
    TH1F *h_eff_dR_truth_Lightjet; //!
    ...
    TH2F *h_2d_eff_dR_truth_Bjet; //!
    TH2F *h_2d_eff_dR_truth_Cjet; //!
    TH2F *h_2d_eff_dR_truth_Lightjet; //!
/*
    // for making plots
...
*/
    ...
    ClassDef(ytRealLeptonsEfficiency_MC, 1);
};
