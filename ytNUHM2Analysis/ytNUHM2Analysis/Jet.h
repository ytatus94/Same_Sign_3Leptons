...
public:
    Jet() : isBjet(0), quality(0), JVT(0), JVTsf(0), MV2c20(0), MV2c10(0), SFw(0), ConeTruthLabel(0), PartonTruthLabel(0), HadronConeExclTruthLabel(0),  deltaR(0), nTrk(0), passOR(0), totalJVTsf(0) {}
    ~Jet() {}
    // get methods
    ...
    float   get_totalJVTsf()                { return totalJVTsf; }
    // set methods
    ...
    void    set_totalJVTsf(float f)             { totalJVTsf = f; }
};
