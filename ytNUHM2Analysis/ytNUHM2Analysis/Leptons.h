...
public:
    Lepton() : flavor(0), isSignal(0),
               charge(0), passOR(0),
               d0pvtx(0), sigd0(0), z0sinTheta(0),
               type(0), origin(0),
               truthType(0), truthOrigin(0),
               bkgTruthType(0), bkgTruthOrigin(0), bkgMotherPdgId(0),
...
class Electron : public Lepton {
    ...
    bool    trigMatch_e24_lhmedium_L1EM20VH;
    bool    trigMatch_e24_lhmedium_nod0_ivarloose;
    bool    trigMatch_e26_lhtight_nod0_ivarloose;
    ...
    float   passChargeFlipTaggerBDTmedium;
    float   passChargeFlipTaggerBDTloose;
...
public:
    Electron() : etaclus(0),
                 ...
                 trigMatch_e24_lhtight_nod0_ivarloose(0), trigMatch_e24_lhmedium_iloose_L1EM20VH(0), trigMatch_e24_lhmedium_L1EM20VH(0), trigMatch_e24_lhmedium_nod0_ivarloose(0),
                 trigMatch_e26_lhtight_nod0_ivarloose(0),
                 trigMatch_e60_lhmedium(0), trigMatch_e60_lhmedium_nod0(0),
                 ...
                 passChargeFlipTaggerBDTmedium(0), passChargeFlipTaggerBDTloose(0)
                 {}
    ~Electron() {}
    // get methods
    ...
    bool    get_trigMatch_e24_lhmedium_L1EM20VH()               { return trigMatch_e24_lhmedium_L1EM20VH; }
    ...
    bool    get_trigMatch_e26_lhtight_nod0_ivarloose()          { return trigMatch_e26_lhtight_nod0_ivarloose; }
    ...
    float   get_passChargeFlipTaggerBDTmedium()                 { return passChargeFlipTaggerBDTmedium; }
    float   get_passChargeFlipTaggerBDTloose()                  { return passChargeFlipTaggerBDTloose; }
    // set methods
    ...
    void    set_trigMatch_e24_lhmedium_L1EM20VH(bool b)                 { trigMatch_e24_lhmedium_L1EM20VH = b; }
    void    set_trigMatch_e24_lhmedium_nod0_ivarloose(bool b)           { trigMatch_e24_lhmedium_nod0_ivarloose = b; }
    void    set_trigMatch_e26_lhtight_nod0_ivarloose(bool b)            { trigMatch_e26_lhtight_nod0_ivarloose = b; }
    ...
    void    set_passChargeFlipTaggerBDTmedium(float f)                  { passChargeFlipTaggerBDTmedium = f; }
    void    set_passChargeFlipTaggerBDTloose(float f)                   { passChargeFlipTaggerBDTloose = f; }
};
...
class Muon : public Lepton {
    ...
    bool            trigMatch_mu20_iloose_L1MU15;
    ...
    bool            trigMatch_mu26_ivarmedium;
    bool            trigMatch_mu40;
    bool            trigMatch_mu50;
    bool            trigMatch_e17_lhloose_mu14;
    bool            trigMatch_e17_lhloose_nod0_mu14;
...
public:
    Muon() : isBad(0), isCosmic(0), isTight(0),
             SFw(0), IsoSFw(0),
             MuTrigSF_HLT_mu20_iloose_L1MU15_OR_HLT_mu50(0),
             trigMatch_mu8noL1(0), 
             trigMatch_mu14(0),
             trigMatch_mu18(0), trigMatch_mu18_mu8noL1(0),
             trigMatch_mu20_mu8noL1(0), trigMatch_mu20_iloose_L1MU15(0),
             trigMatch_mu22_mu8noL1(0),
             trigMatch_mu24_iloose(0), trigMatch_mu24_iloose_L1MU15(0), trigMatch_mu24_ivarloose(0), trigMatch_mu24_ivarloose_L1MU15(0),
             trigMatch_mu26_ivarmedium(0),
             trigMatch_mu40(0),
             trigMatch_mu50(0),
    ...
    bool    get_trigMatch_mu20_iloose_L1MU15()                  { return trigMatch_mu20_iloose_L1MU15; }
    ...
    bool    get_trigMatch_mu26_ivarmedium()                     { return trigMatch_mu26_ivarmedium; }
    bool    get_trigMatch_mu40()                                { return trigMatch_mu40; }
    ...
    void    set_trigMatch_mu20_iloose_L1MU15(bool b)                    { trigMatch_mu20_iloose_L1MU15 = b; }
    ...
    void    set_trigMatch_mu26_ivarmedium(bool b)                       { trigMatch_mu26_ivarmedium = b; }
    void    set_trigMatch_mu40(bool b)                                  { trigMatch_mu40 = b; }
