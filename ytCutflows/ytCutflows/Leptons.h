...
public:
    Muon() : SFw(0), IsoSFw(0),
             ...
             trigMatchPair_mu18_mu8noL1(10, false), trigMatchPair_mu20_mu8noL1(10, false) // create 10 elements and initialize them to false. This is not a good way because we don't know the number of elements in advance.
             {}
