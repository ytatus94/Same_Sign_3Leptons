...
// Fri Jul  1 23:53:56 2016 by ROOT version 6.04/16
// from TTree AnaNtup/AnaNtup
// found on file: user.jpoveda.8707424._000001.output.root
//////////////////////////////////////////////////////////
...
class AnaNtup_MC : public TSelector {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<bool>    *El_trigMatch_2e17_lhvloose_nod0_L12EM15VH;
   ...
   TBranch        *b_El_trigMatch_2e17_lhvloose_nod0_L12EM15VH;   //!
   ...
   AnaNtup_MC(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~AnaNtup_MC() { }
   ...
   ClassDef(AnaNtup_MC,0);
};

#endif

#ifdef AnaNtup_MC_cxx
void AnaNtup_MC::Init(TTree *tree)
{
   ...
   El_trigMatch_2e17_lhvloose_nod0_L12EM15VH = 0;
   ...
   fChain->SetBranchAddress("El_trigMatch_2e17_lhvloose_nod0_L12EM15VH", &El_trigMatch_2e17_lhvloose_nod0_L12EM15VH, &b_El_trigMatch_2e17_lhvloose_nod0_L12EM15VH);
