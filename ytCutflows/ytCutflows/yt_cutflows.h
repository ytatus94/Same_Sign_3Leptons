...
public:
    ...
    void print();
    int get_mc_random_event_number(int isData, int isMC,
    ...
    bool pass_2016_trigger(bool HLT_2e17_lhvloose_nod0, bool HLT_e17_lhloose_nod0_mu14, bool HLT_mu20_mu8noL1, bool HLT_xe80_tc_lcw_L1XE50, float Etmiss_TST_Et);
    bool pass_trigger(int isData, int isMC, int run_number, int random_run_number,
