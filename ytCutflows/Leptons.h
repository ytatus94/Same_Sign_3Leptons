...
public:
    Electron() : etaclus(0),
                 ...
                 SFwTrigMediumLH_e12_lhloose_L1EM10VH(0),
                 SFwTrigLooseAndBLayerLH_e12_lhloose_L1EM10VH(0),
                 nBLayerHits(0), expectBLayerHit(0), 
                 bkgMotherPdgId(0), bkgOrigin(0), 
                 chFlip(0),
                 trigMatch_e60_lhmedium(0), trigMatch_e24_lhmedium_iloose_L1EM20VH(0),
                 trigMatch_e17_lhloose(0), trigMatch_e12_lhloose_L1EM10VH(0) {}
    ~Electron() {}
    // get methods
...
public:
    Muon() : SFw(0), IsoSFw(0),
             ...
             trigMatch_mu26_imedium(0), trigMatch_mu50(0),
             trigMatch_mu14(0), trigMatch_mu18(0), trigMatch_mu18_mu8noL1(0) {}
    ~Muon() {}
    // get methods
