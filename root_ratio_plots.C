...
void root_ratio_plots()
{
    ...
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Jet_Pt",
                    "Jet Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Jet_Pt.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Jet_Pt1",
                    "Jet 1 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Jet_Pt1.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Jet_Pt2",
                    "Jet 2 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Jet_Pt2.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Jet_Pt3",
                    "Jet 3 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Jet_Pt3.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Jet_Pt4",
                    "Jet 4 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
    ...
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Elec_Pt",
                    "Elec Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Elec_Pt.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Elec_Pt1",
                    "Elec 1 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Elec_Pt1.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Elec_Pt2",
                    "Elec 2 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
    ...
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Muon_Pt",
                    "Muon Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Muon_Pt.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Muon_Pt1",
                    "Muon 1 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Muon_Pt1.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_Muon_Pt2",
                    "Muon 2 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
    ...
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_lep_Pt",
                    "Lept Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_Lept_Pt.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_lep_Pt1",
                    "lep 1 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
                    "ratio_ttbar_lep_Pt1.pdf");
    make_ratio_plot(file50ns.c_str(), file25ns.c_str(),
                    "hCut5_lep_Pt2",
                    "lep 2 Pt (GeV)", "", "50ns/25ns",
                    0., 1000.,
                    0.000001, 1,
